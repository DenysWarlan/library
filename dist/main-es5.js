    ...
    BookComponent.prototype.addToLibrary = function (book) {
        ...
        if (this.oldLibrary) {
            if (this.oldLibrary.books.length > 9) {
                ...
                var books = tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](this.oldLibrary.books);
                if (books.length === 0) {
                    this.addBook(book);
                }
                else {
                    try {
                        for (var books_1 = tslib__WEBPACK_IMPORTED_MODULE_0__["__values"](books), books_1_1 = books_1.next(); !books_1_1.done; books_1_1 = books_1.next()) {
                            var oldBook = books_1_1.value;
                            var oldBookId = oldBook.book.id;
...
var BooksComponent = /** @class */ (function () {
    ...
    BooksComponent.prototype.showBooks = function (query) {
        var _this = this;
        this.books.clear();
...
var LibraryBookComponent = /** @class */ (function () {
    function LibraryBookComponent(userService, booksComponent, userLibraryComponent) {
        this.userService = userService;
    ...
    LibraryBookComponent.prototype.removeToLibrary = function (book) {
        ...
        try {
            for (var books_1 = tslib__WEBPACK_IMPORTED_MODULE_0__["__values"](books), books_1_1 = books_1.next(); !books_1_1.done; books_1_1 = books_1.next()) {
                var haveBook = books_1_1.value;
                var index = books.indexOf(haveBook);
        ...
        return this.userService.updateBookList(this.oldLibrary, this.user.id)
            ...
            try {
                for (var items_1 = tslib__WEBPACK_IMPORTED_MODULE_0__["__values"](items), items_1_1 = items_1.next(); !items_1_1.done; items_1_1 = items_1.next()) {
                    var item = items_1_1.value;
                    _this.userLibraryComponent.books.push(item.book);
                }
            }
    ...
    LibraryBookComponent.ctorParameters = function () { return [
        { type: src_app_shared_services_users_service__WEBPACK_IMPORTED_MODULE_2__["UsersService"] },
...
var SearchComponent = /** @class */ (function () {
    ...
    SearchComponent.prototype.searchBook = function (querySearch) {
...
var BooksService = /** @class */ (function () {
    ...
    BooksService.prototype.getBooks = function (query) {
        var url = "https://www.googleapis.com/books/v1/volumes?q=" + query.query + "&key=AIzaSyB6hiZBAGaa0Kj946BgGl_DFUwFiLWJhCE";
        return this.http.get(url);
    };
    BooksService.prototype.getBook = function (selfLink) {
...
var UsersService = /** @class */ (function () {
    ...
    UsersService.prototype.registerUser = function (data) {
    ...
    UsersService.prototype.getLibrary = function (id) {
...
var LoggedInComponent = /** @class */ (function () {
    function LoggedInComponent(authService) {
        this.authService = authService;
        this.isAuthentication = false;
    }
    ...
    LoggedInComponent.ctorParameters = function () { return [
        { type: _shared_services_auth_service__WEBPACK_IMPORTED_MODULE_2__["AuthService"] }
    ]; };
...
var LoginComponent = /** @class */ (function () {
    function LoginComponent(router, usersService, authservice, route) {
        this.router = router;
    ...
    LoginComponent.prototype.loginUser = function () {
        var _this = this;
        var emailUser = this.form.get('email').value;
        var pass = this.form.get('pass').value;
        this.usersService.getUserByEmail(emailUser).subscribe(function (user) {
            if (user) {
                if (pass === user['pass']) {
                    window.localStorage.setItem('user', JSON.stringify(user));
                    _this.authservice.login();
                    _this.router.navigate(["" + user['username']]);
                }
                else {
                    _this.showMessage({
...
var RegisterComponent = /** @class */ (function () {
    ...
    RegisterComponent.prototype.submitForm = function () {
        ...
        this.usersService.getUserByEmail(emailUser).subscribe(function (user) {
            if (user) {
                ...
                _this.usersService.registerUser(_this.form.value).subscribe(function (data) {
    ...
    RegisterComponent.prototype.showMessage = function (message) {
        var _this = this;
        this.message = message;
        this.isShowAlert = true;
        window.setTimeout(function () {
...
var UnloggedInComponent = /** @class */ (function () {
    function UnloggedInComponent() {
    }
    UnloggedInComponent.prototype.ngOnInit = function () {
    };
...
var UserLibraryComponent = /** @class */ (function () {
    function UserLibraryComponent(userService) {
        this.userService = userService;
        this.slideConfig = {
            'slidesToShow': 3,
            'slidesToScroll': 1,
    ...
    UserLibraryComponent.prototype.ngOnInit = function () {
        this.getLibrary();
    };
    UserLibraryComponent.prototype.getLibrary = function () {
        var _this = this;
        this.books = [];
        var user = JSON.parse(window.localStorage.getItem('user'));
        this.userService.getLibrary(user.id).subscribe(function (response) {
            var e_1, _a;
            var items = response['books'];
            try {
                for (var items_1 = tslib__WEBPACK_IMPORTED_MODULE_0__["__values"](items), items_1_1 = items_1.next(); !items_1_1.done; items_1_1 = items_1.next()) {
                    var item = items_1_1.value;
                    _this.books.push(item.book);
                }
            }
            catch (e_1_1) { e_1 = { error: e_1_1 }; }
            finally {
    ...
    UserLibraryComponent.ctorParameters = function () { return [
